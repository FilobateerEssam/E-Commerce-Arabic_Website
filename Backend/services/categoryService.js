...
exports.createCategory = asyncHandler(async (req, res) => {
  ...
  // async await
    ...
    res.status(201).json({message: `Category Created Successfilly` , data: category  });
...
exports.updateCategory = asyncHandler(async (req, res) => {
  ...
  (
    ...
    {new : true}) // new : true to return new data after update not old data
...
res.status(200).json({message: `Category Updated Successfilly` , data: category });
});
